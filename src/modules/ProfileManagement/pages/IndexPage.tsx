...
import { FeaturesSection } from "@/modules/Landing/components/features/FeaturesSection";
import { PricingSection } from "@/modules/Landing/components/pricing/PricingSection";
import LogoCarousel from "@/modules/Landing/components/LogoCarousel";
...
const IndexPage = () => {
  ...
  useEffect(() => {
    // Verify against backend cookie, not just localStorage cache
